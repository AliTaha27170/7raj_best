<!-- content -->
							...
							<div class="row align-items-end ">
								<div class="col-lg-8">
									<div class="page-header-title text-left-rtl">
										<div class="d-inline">
											<h3 class="lite-text ">لوحة التحكم الرئيسية </h3>
											<span class="lite-text text-gray"> الخاصة بموقع أفضل حراج </span>
										</div>
									</div>
								</div>
								<div class="col-lg-4">
				...
				<div class="row m-1 mb-2">
					<div class="col-xl-3 col-md-6 col-sm-6 p-2">
						<div class="box-card mini animate__animated animate__flipInY   "><i
							...
							<span class="c-first"> عدد المستخدمبن </span>
							<span>50</span>
								مستخدم</p>
						</div>
					</div>
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-6 p-2">
						<div class="box-card mini animate__animated animate__flipInY   "><i
								class="fab far fa-chart-bar b-first" aria-hidden="true"></i>
							<span class="c-first"> عدد الإعلانات الكلية  </span>
							<span>50</span>
								إعلان </p>
						</div>
					</div>
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-6 p-2">
						<div class="box-card mini animate__animated animate__flipInY   "><i
								class="fab far fa-chart-bar b-first" aria-hidden="true"></i>
							<span class="c-first"> عدد الإعلانات التي <br> بحاجة لموافقة  </span>
							<span>9</span>
								إعلانات</p>
						</div>
					</div>
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-6 p-2">
						<div class="box-card mini animate__animated animate__flipInY   "><i
								class="fab far fa-chart-bar b-first" aria-hidden="true"></i>
							<span class="c-first"> عدد الإعلانات الملغية  </span>
							<span>18</span>
								إعلان</p>
						</div>
					</div>
					...
					<div class="col-xl-3 col-md-6 col-sm-6 p-2">
						<div class="box-card mini animate__animated animate__flipInY   "><i
							...
							<span class="c-forth">نسبة الربح من <br> الإعلان الطبيعي</span>
							<span>1.5 % </span>
                ...
                <div class="col-xl-3 col-md-6 col-sm-6 p-2">
                    <div class="box-card mini animate__animated animate__flipInY   "><i
                            class="fab far fa-gem b-forth" aria-hidden="true"></i>
                        <span class="c-forth">نسبة الربح من <br> الإعلان المميز</span>
                        <span>3.5 % </span>
